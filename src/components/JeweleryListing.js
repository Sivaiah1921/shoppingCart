...
const JeweleryListing = (props) =>{
    
  const {_products} = props._products
  const filterJewelery = _products.filter((value) => value.category === "jewelery");
  console.log(filterJewelery, "_products");
      ...
      <div className="product">
        ...
        <div className="product__main">
          ...
          <div className="product__listingItems">
            {filterJewelery.length === 0 ? (
              <div className="product__listingItems">
                <h2>Loading...!</h2>
              </div>
            ) : (
                filterJewelery.map((item, index) => (
                <div
                  key={index}
...
export default connect(mapStateToProps, mapDispatchToProps)(JeweleryListing);
