...
const MensList = (props) =>{
  ...
  const filterMens = _products.filter((value) => value.category === "men's clothing");
  console.log(filterMens, "_products");
...
export default connect(mapStateToProps, mapDispatchToProps)(MensList);
